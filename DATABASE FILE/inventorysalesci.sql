...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Agu 2023 pada 10.16
...
(1, 'Admin', 'Liam', 'admin@gmail.com', '7012224570', '7014547000', '$2y$10$7rLSvRVyTQORapkDOqmkhetjF6H9lJHngr4hJMSM2lHObJbW5EQh6', 'Super', '2017-01-04 22:19:16', '2023-08-09 13:32:33', '2023-08-09 15:16:14', '2023-08-09 08:16:14', '1', '0'),
...
--
-- Dumping data untuk tabel `eventlog`
--
...
(39, 'New Transaction', '1259173', '1 items totalling $23.76 with reference number 1259173 was purchased', 'transactions', 1, '2023-08-09 06:35:36'),
(40, 'Creation of new item', '24', 'Addition of 10 quantities of a new item \'speaker aktif\' with a unit price of $350.00 to stock', 'items', 1, '2023-08-09 08:06:10');
...
--
-- AUTO_INCREMENT untuk tabel `eventlog`
--
ALTER TABLE `eventlog`
...
--
ALTER TABLE `transactions`
  MODIFY `transId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
COMMIT;
